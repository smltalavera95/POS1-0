...
{
  //Mostrar los valores de las ventas y compras de hoy
...
<script type="text/javascript">
  ...
  var compras = new Chart(ctx, {
      ...
      data: {
          ...
          datasets: [{
              label: '# Compras en colones de los últimos 10 dias',
  ...
  var ventas = new Chart(ctx, {
      ...
      data: {
          ...
          datasets: [{
              label: '# Ventas en colones de los últimos 12 meses',
