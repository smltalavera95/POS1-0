                    ...
                    <div class="panel-body" style="height: 400px;" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <label>Nombre:</label>
                            <input type="hidden" name="idpersona" id="idpersona"><!--Para enviar el id persona de una manera oculta, y asi luego pueda editar-->
                            <input type="hidden" name="tipo_persona" id="tipo_persona" value="Proveedor"><!--Se envia oculto el Value para que cuando registre, sole registre como proveedor-->
                          ...
                          <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <input type="text" class="form-control" name="num_documento" id="num_documento" maxlength="20" placeholder="Número Documento">
                          </div>
                          ...
                          <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <input type="text" class="form-control" name="telefono" id="telefono" maxlength="20" placeholder="Número Teléfono">
                          </div>
