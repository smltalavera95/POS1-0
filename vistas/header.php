<?php   
//Verifica si la sesion esta iniciada, ya que si se inicia de una vez puede dar error porque en otro documentos se inicia
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-mini"><b>POS</b>CELFIX</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>POS CELFIX</b></span>
        </a>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      ...
                      <small>Nombre Usuario: <?php echo $_SESSION['login']; ?></small>
                    </p>
                  </li>
